...
import "./KulinBanToken.sol";

contract KulinBanTokenPreSale {
    KulinBanToken public token;
    ...
    function KulinBanTokenPreSale(
        KulinBanToken _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = KulinBanToken(_token);
        beneficiary = _beneficiary;
        alfatokenteam = _alfatokenteam;
        bonus = 20;
        price = 0;
        minSaleAmount = 200000000;
    }
